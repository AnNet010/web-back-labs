...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'anna_bobrova_orm'
    db_user = 'anna_bobrova_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, "anna_bobrova_orm.db")
    ...
    <main>
        <nav>
            <ul>
                ...
                # <li><a href="/rgz/">Расчётно-графическое задание (Сайт знакомств)</a></li>
            </ul>
        </nav>
    </main>
    <footer>
